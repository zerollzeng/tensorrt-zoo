        ...
        const unsigned int numberBodyPartPairs, const Array<T>& pairScores)
    {
        try
        {
            ...
            for (auto pairIndex = 0u; pairIndex < numberBodyPartPairs; pairIndex++)
            {
                ...
                // std::cout << "--------------" << std::endl;
                // std::cout << "bodyPartA: " << bodyPartA << " bodyPartB: " << bodyPartB << std::endl;
                // std::cout << "numberPeaksA: " << numberPeaksA << " numberPeaksB: " << numberPeaksB << std::endl;
...
//     }
        ...
        const bool maximizePositives)
    {
        try
        {
            // std::cout << "---------------" << " dubug body part connect " <<  "-------" << std::endl;
            // std::cout << "heatMapSize: " << heatMapSize.x << " " << heatMapSize.y << std::endl;
            // std::cout << "maxPeaks: " << maxPeaks << std::endl;
            // std::cout << "interMinAboveThreshold: " << interMinAboveThreshold << std::endl;
            // std::cout << "interThreshold: " << interThreshold << std::endl;
            // std::cout << "minSubsetCnt: " << minSubsetCnt << std::endl;
            // std::cout << "minSubsetScore: " << minSubsetScore << std::endl;
            // std::cout << "scaleFactor: " << scaleFactor << std::endl;
            // std::cout << "maximizePositive: " << maximizePositives << std::endl;
            // Parts Connection
            const auto& bodyPartPairs = std::vector<unsigned int>{1,8,   1,2,   1,5,   2,3,   3,4,   5,6,   6,7,   8,9,   9,10,  10,11, 8,12,  12,13, 13,14,  1,0,   0,15, 15,17,  0,16, 16,18,   2,17,  5,18,   14,19,19,20,14,21, 11,22,22,23,11,24};
            const auto numberBodyParts = 25;
            const auto numberBodyPartPairs = (unsigned int)(bodyPartPairs.size() / 2);
